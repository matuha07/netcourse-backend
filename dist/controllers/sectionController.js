...
var createSection = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var courseId, _a, title, orderIndex, section, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                courseId = req.params.courseId;
                _a = req.validated.body, title = _a.title, orderIndex = _a.orderIndex;
                return [4 /*yield*/, prisma_1.default.section.create({
                        data: { courseId: Number(courseId), title: title, orderIndex: orderIndex },
                    })];
            case 1:
                section = _b.sent();
...
var getAllSections = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var sections, error_2;
...
var getSectionById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var sectionId, section, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                sectionId = req.params.sectionId;
                return [4 /*yield*/, prisma_1.default.section.findUnique({
...
var updateSection = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, title, orderIndex, updated, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                id = req.params.id;
                _a = req.validated.body, title = _a.title, orderIndex = _a.orderIndex;
                return [4 /*yield*/, prisma_1.default.section.update({
                        where: { id: Number(id) },
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, prisma_1.default.section.delete({
                        where: { id: Number(id) },
                    })];
            case 1:
                _a.sent();
